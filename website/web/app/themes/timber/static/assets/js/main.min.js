...
/***/ "./assets/js/controllers/DownloadFormController.js":
/*!*********************************************************!*\
  !*** ./assets/js/controllers/DownloadFormController.js ***!
  \*********************************************************/
/*! exports provided: DownloadFormController */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DownloadFormController", function() { return DownloadFormController; });
var DownloadFormController = () => {
  var postPage = document.querySelector(".single-post");
  ...
  wpcf7.addEventListener("wpcf7mailsent", function () {
    showDownload();
  }, false); // // TODO: FOR TESTING PURPOSE
...
var showDownload = () => {
  var p = nucleon_params;
  var pdfLink = p.pdf_link;
  var download = p.download;
  var decodedLink = atob(pdfLink);
  var postDownloadTitle = document.querySelector(".post_download__extra-information");
  var postDownloadForm = document.querySelector(".post_download__form");
  var postDownloadButton = document.querySelector(".post_download__button");
  postDownloadTitle.style.display = "none";
  postDownloadForm.style.display = "none";
  var downloadTitle = document.createElement("h2");
...
var HeaderController = () => {
  ...
  var storeScroll = () => {
    ...
    var scrollHeight = windowHeight - innerHeight;
    var scrollPercentage = 100 / scrollHeight * (scrollPosition / 100) * 100;
    var scrollBar = document.querySelector('.scrollbar');
    scrollBar.style.height = scrollPercentage;
  }; // Listen for new scroll events


  document.addEventListener('scroll', storeScroll); // Update scroll position for first time

  storeScroll();
  var hamburger = document.querySelector('.nav-main-mobile .hamburger-icon');
...
var loadMoreButton = () => {
  ...
  loadMore.addEventListener('click', e => {
    ...
    var buttonText = e.currentTarget.querySelectorAll('span');
    var data = {
      action: 'loadmore',
      query: l.posts,
      page: l.current_page,
...
/* harmony import */ var _controllers_LoadMoreController_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/LoadMoreController.js */ "./assets/js/controllers/LoadMoreController.js");
/* harmony import */ var _controllers_HeaderController_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controllers/HeaderController.js */ "./assets/js/controllers/HeaderController.js");
/* harmony import */ var _controllers_DownloadFormController_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/DownloadFormController.js */ "./assets/js/controllers/DownloadFormController.js");
...
var init = () => {
  ...
  Object(_controllers_LoadMoreController_js__WEBPACK_IMPORTED_MODULE_2__["LoadMoreController"])();
  Object(_controllers_HeaderController_js__WEBPACK_IMPORTED_MODULE_3__["HeaderController"])();
  Object(_controllers_DownloadFormController_js__WEBPACK_IMPORTED_MODULE_4__["DownloadFormController"])();
};
...
/*!**********************************!*\
  !*** ./assets/js/utils/Utils.js ***!
  \**********************************/
/*! exports provided: lazyLoadImages, convertRemToPixels */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
